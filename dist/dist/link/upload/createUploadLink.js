...
import { ApolloLink, selectURI, fromError, Observable, checkFetcher, fallbackHttpConfig } from '@apollo/client';
import { createSignalIfSupported } from '../http/createSignalIfSupported.js';
import { parseAndCheckHttpResponse } from '../http/parseAndCheckHttpResponse.js';
import { serializeFetchParameter } from '../http/serializeFetchParameter.js';
import { rewriteURIForGET } from '../http/rewriteURIForGET.js';
import { selectHttpOptionsAndBody } from '../http/selectHttpOptionsAndBody.js';
